...
@section('js')
            ...
            function inicializarIndividual() {
               ...
               $(".listarindividual").DataTable({
                    ...
                    "initComplete": function( settings, json ) {
                        ...
                        // let countAtrasado = table_individual.column(11).data().filter((value, index) => {
                        //     return value === 'Atrasado' && table_individual.column(9).data()[index] !== 'Cancelado';
                        // }).length;
    ...
    '12': "Dezembro"
            ...
            $("#atrasado_corretor").on('click',function(){
                ...
                table_individual.column(9).search('^(?!.*Cancelado).*$', true, false).draw();

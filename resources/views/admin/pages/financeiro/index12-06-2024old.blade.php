        ...
        $(document).ready(function(){
            ...
            function inicializarIndividual() {
               ...
               $(".listarindividual").DataTable({
                    ...
                    "columnDefs": [
                        ...
                        {"targets": 7,"width":"8%"},
                        {"targets": 8,"width":"5%"},
                        {"targets": 9,"width":"3%","visible": false},
                        {"targets": 10,"width":"10%"},
                        {"targets": 11,"width":"2%",
                            "createdCell": function (td, cellData, rowData, row, col) {
                    ...
                    "initComplete": function( settings, json ) {
                        ...
                        let countPagamento1 = this.api().column(10).data().filter((value, index) => value === 'Pag. 1º Parcela').length;
                        let countPagamento2 = this.api().column(10).data().filter((value, index) => value === 'Pag. 2º Parcela').length;
                        let countPagamento3 = this.api().column(10).data().filter((value, index) =>  value === 'Pag. 3º Parcela').length;
                        let countPagamento4 = this.api().column(10).data().filter((value, index) => value === 'Pag. 4º Parcela').length;
                        let countPagamento5 = this.api().column(10).data().filter((value, index) =>  value === 'Pag. 5º Parcela').length;
                        let countPagamento6 = this.api().column(10).data().filter((value, index) => value === 'Finalizado').length;
                        let countAtrasado = this.api().column(12).data().filter((value, index) => value === 'Atrasado').length;

                        let countCancelados = this.api().column(10).data().filter((value, index) =>  value === 'Cancelado').length;
            ...
            $("#mudar_mes_table").on('change',function(){
                ...
                if(mes != 00) {
                    ...
                    let dadosColuna9 = table_individual.column(10,{search: 'applied'}).data();
                    let dadosColuna11 = table_individual.column(12,{search: 'applied'}).data();
                    let primeiraParcelaIndividual = 0;
                    let segundaParcelaIndividual = 0;
                    let terceiraParcelaIndividual = 0;
                    let quartaParcelaIndividual = 0;
            ...
            $("#select_usuario_individual").on('change',function(){
                ...
                if(valorSelecionado != "todos") {
                    table_individual.column(10).search('').draw();
            ...
            $("ul#listar_individual li.individual").on('click',function(){
                ...
                if(id_lista == "aguardando_em_analise_individual") {
                    ...
                    table_individual.column(10).search('Pag. 1º Parcela').draw();
                    ...
                    table_individual.column(12).search('').draw();
                    table_individual.column(10).search('Pag. 2º Parcela').draw();
                    ...
                    table_individual.column(12).search('').draw();
                    table_individual.column(10).search('Pag. 3º Parcela').draw();
                    ...
                    table_individual.column(10).search('Pag. 4º Parcela').draw();
                    $("#atrasado_corretor").removeClass('textoforte-list').removeClass('destaque_content_radius');
                    $(".container_edit").addClass('ocultar')
                    $("ul#listar_individual li.individual").removeClass('textoforte-list');
                    $("#all_pendentes_individual").removeClass('textoforte-list');
                    ...
                    table_individual.column(10).search('Pag. 5º Parcela').draw();
                    $(".container_edit").addClass('ocultar');
                    $("ul#listar_individual li.individual").removeClass('textoforte-list');
                    $("#all_pendentes_individual").removeClass('textoforte-list');
                    $("ul#grupo_finalizados_individual li.individual").removeClass('textoforte-list');
            ...
            $("#aguardando_pagamento_6_parcela_individual").on('click',function(){
                ...
                let dataId = $("#select_usuario_individual").find('option:selected').data('id');
                table_individual.column(12).search('').draw();
                table_individual.column(10).search('Finalizado').draw();
            ...
            $("#atrasado_corretor").on('click', function() {
                ...
                $.fn.dataTable.ext.search.push(
                    function(settings, data, dataIndex) {
                        ...
                        var status = data[12]; // The status column (adjust the index if necessary)
                        var parcelas = data[10]; // The parcelas column (adjust the index if necessary)
            ...
            $("#cancelado_individual").on('click',function(){
                ...
                table_individual.column(10).search('Cancelado').draw();

    ...
    <main class="container_full_cards">
        ...
        <div class="d-flex">
            <div style="flex-basis:18%;">
                ...
                <input type="text" name="data_contrato" id="data_contrato" class="form-control form-control-sm" value="{{date('d/m/Y',strtotime($dados->created_at))}}" readonly>
            </div>
        ...
        @if($cancelados == 0)
            ...
            @switch($dados->financeiro_id)
                ...
                @case(3)
                    ...
                    <button class="btn btn-success w-50 pagamento_adesao next">Pagar Adesão</button>
                @break

                @case(4)
                    <button class="btn btn-danger w-50 mr-2 cancelar">Cancelar</button>
                    <button class="btn btn-success w-50 pagamento_segunda_parcela next">Pagar Vigência</button>
                @break

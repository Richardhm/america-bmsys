...
@section('content_top_nav_right')
    <li class="nav-item"><a class="nav-link text-white" href="{{route('orcamento.search.home')}}">Tabela de Preço</a>
    </li>
    <li class="nav-item"><a class="nav-link text-white" href="{{route('home.administrador.consultar')}}">Consultar</a>
    </li>
...
@section('content')
    ...
    <div class="modal fade" id="dataBaixaModal" tabindex="-1" role="dialog" aria-labelledby="dataBaixaModalLabel"
         aria-hidden="true">
    ...
    <section class="conteudo_abas" style="padding:5px;">
        ...
        <ul class="list_abas" style="margin-top:1px;">
            <li data-id="aba_comissao" class="menu-inativo ativo">Folha</li>
            <li data-id="aba_historico" class="menu-inativo" style="margin:0 1%;">Historico</li>
            <li class="ocultar" id="corretor_em_destaque"></li>
        </ul>

        <main id="aba_comissao" class="aba_comissao_container">
            <section
                style="display:flex;flex-basis:24%;flex-wrap:wrap;align-items: flex-start;align-content: flex-start;">

                <div class="menu_aba_comissao">
                    <div style="background-color: #123449;padding:3px;">
                        <select name="ano_folha" id="ano_folha"
                                class="form-control form-control-sm mb-1 tamanho_de_25" {{$mes != null && !empty($mes) ? 'disabled' : ''}}>
                        ...
                        <ul style="margin:0;padding:0;">
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                <span
                                    style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                                    Faturamento:
                                </span>
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" name="comissao" id="comissao" value="{{$total_comissao}}"
                                           class="form-control form-control-sm" readonly placeholder="Comissão"
                                           value="0" style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" name="adiantamento" id="adiantamento" value="{{$total_adiantamento ?? 0}}"
                                           class="form-control form-control-sm" readonly placeholder="Adiantamento"
                                           value="0" style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                <span
                                    style="display:flex;flex-basis:50%;align-self: center;color:#FFF;font-size:0.7em;">
                                    Estorno:
                                </span>
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled id="valor_total_desconto_geral"
                                           value="{{$total_estorno}}" name="estorno_geral" id="estorno_geral"
                                           class="form-control form-control-sm estorno_usuario"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled id="valor_total_desconto" value="{{$total_desconto}}"
                                           name="desconto" id="desconto"
                                           class="form-control form-control-sm desconto_usuario"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;">
                                <span
                                    style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;height:20px;color:#FFF;">
                                    Total:
                                </span>
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled name="total_campo" value="{{$total_mes}}"
                                           id="total_campo" class="form-control form-control-sm total_campo"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                    ...
                    <div style="background-color: #123449;margin-top:2px;margin-bottom:2px;">
                        <p style="color:white;border-bottom:1px solid white;margin:0;padding: 5px 0;display:flex;">
                        ...
                        <ul style="margin:0 0 0 0;padding:0;">
                            ...
                            <li style="display:flex;justify-content: space-between;align-items:center;" data-plano="1"
                                id="listar_individual_apto_total">
                                <span
                                    style="display:flex;flex-basis:50%;font-size:0.68em;margin-left:2px;padding:5px 0;">Individual</span>
                                <span style="display:flex;flex-basis:10%;font-size:0.68em;"
                                      id="total_quantidade_individual_total">{{$total_individual_quantidade}}</span>
                                <span
                                    style="display:flex;flex-basis:40%;justify-content:flex-end;font-size:0.68em;margin-right:2px;"><span
                                        id="valor_total_individual_total">{{$total_individual}}</span></span>
                            </li>
                    ...
                    <div id="list_user">
                        <p style="color:white;border-bottom:1px solid white;text-align: center;margin:0;padding: 0;background-color:#123449;font-size:0.7em;">
                            Corretores</p>
                            ...
                            @foreach($users_apto_apagar as $uu)
                                ...
                                <li class="d-flex justify-content-between text-white w-100 py-1 {{ $iix % 2 == 0 ? 'user_destaque_impar' : '' }}">
                                   <span class="user_nome user_destaque" data-id="{{ $uu->user_id }}">
                                    ...
                                    <span class="user_total total_pagamento_finalizado user_destaque"
                                          data-id="{{ $uu->user_id }}">{{ number_format($uu->total, 2, ",", ".") }}</span>
                                </li>
                            @endforeach
                        </ul>
                ...
                <section style="flex-basis:47%;margin-right: 1%;">
                    <div style="background-color: #123449;padding:3px;">
                        <select name="escolher_vendedor" id="escolher_vendedor"
                                class="form-control form-control-sm mb-1 tamanho_de_25" {{$status_disabled ? 'disabled' : ''}}>
                        ...
                        <ul style="margin:0;padding:0;">
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" name="comissao_vendedor" id="comissao_vendedor"
                                           class="form-control form-control-sm" readonly placeholder="Adiantamento"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" name="adiantamento_vendedor" id="adiantamento_vendedor"
                                           class="form-control form-control-sm adiantamento_usuario_vendedor" placeholder="Adiantamento"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                <input type="text" disabled id="valor_total_estorno_vendedor" name="estorno_vendedor"
                                       class="form-control form-control-sm estorno_usuario_vendedor" placeholder="Estorno"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                            ...
                            <span style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                <input type="text" disabled id="valor_total_desconto_vendedor" name="desconto_vendedor"
                                       class="form-control form-control-sm desconto_usuario_vendedor" placeholder="Desconto"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                            ...
                            <span
                                ...
                                <input type="text" disabled name="total_campo_vendedor" id="total_campo_vendedor"
                                       class="form-control form-control-sm total_campo_vendedor" placeholder="Total"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                        </ul>
                    ...
                    <div style="background-color: #123449;margin-top:2px;">
                        <span
                            style="justify-content:center;display:flex;font-size:0.7em;color:white;border-bottom:1px solid white;padding:5px 0;">Confirmados(?)</span>
                        <ul style="margin:0 0 0 0;padding:0;" id="lista_apto_a_pagar_ul">
                            <li style="display:flex;justify-content: space-between;padding:5px 0;" id="listar_individual_apto">
                                <span
                                    style="display:flex;flex-basis:60%;font-size:0.68em;margin-left:2px;">Individual</span>
                                <span style="display:flex;flex-basis:10%;font-size:0.68em;"
                                      id="total_quantidade_individual">0</span>
                                <span
                                    style="display:flex;flex-basis:30%;justify-content:flex-end;font-size:0.68em;margin-right:2px;"><span
                                        id="valor_total_individual">0</span></span>
                            </li>
                    ...
                    <div style="background-color:#123449;border-radius:5px;margin:2px 0;">
                        <p class="border-bottom text-center" style="margin:0;padding: 5px 0;color: white;font-size:0.7em">
                            Confirmar(?)</p>
                        <ul style="margin:0 0 0 0;padding:0;list-style:none;" class="listar listar_a_receber_ul">
                            <li style="display:flex;font-size:0.68em;color:#FFF;margin-left:2px;padding: 1px 0;display:flex;justify-content: space-between;align-items:center;"
                                class="individual_a_receber">
                    ...
                    <div style="background-color:#123449;border-radius:5px;margin:2px 0;">
                        ...
                        <ul style="margin:0 0 0 0;padding:0;list-style:none;" class="listar_estorno_ul">
                            <li style="font-size:0.68em;display:flex;color:#FFF;margin-left:2px;padding: 5px 0;"
                                class="individual_estorno_receber">Individual
                            </li>
            ...
            <section
                ...
                <div class="menu_aba_comissao">
                    <div style="background-color: #123449;padding:3px;">
                        ...
                        <select name="ano_folha_historico" id="ano_folha_historico"
                                class="form-control form-control-sm mb-1 tamanho_de_25">
                            <option value="" class="text-center">-Ano-</option>
                        ...
                        <select name="mes_folha_historico" id="mes_folha_historico"
                                class="form-control form-control-sm mb-1 tamanho_de_25" disabled>
                        ...
                        <ul style="margin:0;padding:0;">
                            <li style="display:flex;justify-content: space-between;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled name="salario_historico" id="salario_historico" value=""
                                           class="form-control form-control-sm salario_usuario_historico"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" name="comissao_historico" id="comissao_historico" value=""
                                           class="form-control form-control-sm" readonly placeholder="Comissão"
                                           value="0" style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled name="premiacao_historico" id="premiacao_historico"
                                           value="" class="form-control form-control-sm premiacao_usuario"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled value="" name="estorno_geral_historico"
                                           id="estorno_geral_historico"
                                           class="form-control form-control-sm estorno_usuario_historico"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;margin:2px 0;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled id="valor_total_desconto_historico" value=""
                                           name="desconto_historico"
                                           class="form-control form-control-sm desconto_usuario_historico"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                            ...
                            <li style="display:flex;justify-content: space-between;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                    <input type="text" disabled name="total_campo_historico" value=""
                                           id="total_campo_historico"
                                           class="form-control form-control-sm total_campo_historico"
                                           style="text-align:right;height:20px;font-size:0.8em;">
                                </span>
                            </li>
                        </ul>
                    ...
                    <div style="background-color: #123449;margin-top:2px;margin-bottom:2px;">
                        <p style="color:white;border-bottom:1px solid white;margin:0;padding: 0;display:flex;">
                            <span
                                style="flex-basis:90%;justify-content:center;display:flex;font-size:0.7em;">Planos</span>
                            <a style="flex-basis:10%;font-size:0.7em;" id="criar_excel_historico" href="">
                                <i class="fas fa-download fa-sm text-white"></i>
                            </a>
                        </p>
                        <ul style="margin:0 0 0 0;padding:0;">
                            <li style="display:flex;justify-content: space-between;" data-plano="1"
                                id="listar_individual_apto_total_historico">
                                <span
                                    style="display:flex;flex-basis:50%;font-size:0.68em;margin-left:2px;">Individual</span>
                                <span style="display:flex;flex-basis:10%;font-size:0.68em;"
                                      id="total_quantidade_individual_total_historico">0</span>
                                <span
                                    style="display:flex;flex-basis:40%;justify-content:flex-end;font-size:0.68em;margin-right:2px;"><span
                                        id="valor_total_individual_total_historico">R$ 0,00</span></span>
                            </li>
                    ...
                    <div>
                        <button class="btn btn-block btn-sm btn-danger mt-1 estorno_geral_historico_button dsnone">
                            Estorno Geral
                        </button>
                    </div>
                ...
                <section style="flex-basis:47%;margin-right: 1%;">
                    <div style="background-color: #123449;padding:3px;">
                        <select name="escolher_vendedor_vendedor" id="escolher_vendedor_historico"
                                class="form-control form-control-sm mb-1 tamanho_de_25" {{$status_disabled ? 'disabled' : ''}}>
                            <option value="" class="text-center">--Corretores--</option>
                        ...
                        <span style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                            Salario:
                                ...
                                <span style="display:flex;flex-basis:50%;">
                            <input type="text" name="salario_vendedor_historico" id="salario_vendedor_historico"
                        ...
                        <span style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                            Comissão:
                                ...
                                <span style="display:flex;flex-basis:50%;">
                            <input type="text" name="comissao_vendedor_historico" id="comissao_vendedor_historico"
                                   class="form-control form-control-sm" readonly placeholder="Comissão"
                                   style="text-align:right;height:20px;font-size:0.8em;">
                        </span>
                            </li>
                        ...
                        <span style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                            Premiação:
                                ...
                                <span style="display:flex;flex-basis:50%;">
                            <input type="text" name="premiacao_vendedor_historico" id="premiacao_vendedor_historico"
                                   class="form-control form-control-sm premiacao_usuario_vendedor"
                                   style="text-align:right;height:20px;font-size:0.8em;">
                        </span>
                            </li>
                            ...
                            Estorno:
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                <input type="text" disabled id="valor_total_estorno_vendedor_historico"
                                       name="estorno_vendedor_historico"
                                       class="form-control form-control-sm estorno_usuario_vendedor"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                            ...
                            <span style="display:flex;flex-basis:50%;align-self: center;font-size:0.7em;color:#FFF;">
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                <input type="text" disabled id="valor_total_desconto_vendedor_historico"
                                       name="desconto_vendedor_historico"
                                       class="form-control form-control-sm desconto_usuario_vendedor"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                            ...
                            Total:
                                ...
                                <span style="display:flex;flex-basis:50%;">
                                <input type="text" disabled name="total_campo_vendedor_historico"
                                       id="total_campo_vendedor_historico"
                                       class="form-control form-control-sm total_campo_vendedor"
                                       style="text-align:right;height:20px;font-size:0.8em;">
                            </span>
                            </li>
                        </ul>
                    ...
                    <div style="background-color: #123449;margin-top:2px;">
                        <span
                            style="justify-content:center;display:flex;font-size:0.7em;color:white;border-bottom:1px solid white;">Planos</span>
                        <ul style="margin:0 0 0 0;padding:0;" id="lista_apto_a_pagar_ul_historico">
                            <li style="display:flex;justify-content: space-between;"
                                id="listar_individual_apto_historico">
                                <span
                                    style="display:flex;flex-basis:60%;font-size:0.68em;margin-left:2px;">Individual</span>
                                <span style="display:flex;flex-basis:10%;font-size:0.68em;"
                                      id="total_quantidade_individual_historico">0</span>
                                <span
                                    style="display:flex;flex-basis:30%;justify-content:flex-end;font-size:0.68em;margin-right:2px;"><span
                                        id="valor_total_individual_historico">0</span></span>
                            </li>
            ...
            <section style="display:flex;flex-basis:75%;">
                ...
                <section style="flex-basis:100%;">
                    <div style="color:#FFF;border-radius:5px;" id="tabela_aptos_a_pagar_historico" class="dsnone">
                        <div class="p-2" style="background-color:#123449;border-radius:5px;">
                            <table id="tabela_aptos_a_pagar_table_historico"
                                   class="table table-sm listaraptosapagarhistorico w-100" style="table-layout: fixed;">
                                <thead>
                                <tr>
                                    <th>Admin</th>
                                    <th>Data</th>
                    ...
                    <div style="color:#FFF;border-radius:5px;" id="tabela_principal_historico">
                        <div style="background-color:#123449;border-radius:5px;">
                            <table id="tabela_mes_recebidas_historico"
                                   class="table table-sm listarcomissaomesrecebidashistorico w-100">
                                <thead>
                                <tr>
                                    <th>Admin</th>
                                    <th>Data</th>
                    ...
                    <div style="color:#FFF;" id="listar_a_receber_historico" class="dsnone">
                        <div style="background-color:#123449;border-radius:5px;">
                            <table id="tabela_mes_diferente_historico"
                                   class="table table-sm listarcomissaomesdiferentehistorico"
                                   style="table-layout: fixed;">
                                <thead>
                                <tr>
                                    <th>Admin</th>
                    ...
                    <div style="color:#FFF;border-radius:5px;" id="tabela_estorno_historico" class="dsnone">
                        <div class="p-2" style="background-color:#123449;border-radius:5px;">
                            <table id="tabela_estorno_table_historico"
                                   class="table table-sm listarestornoshistorico w-100">
                                <thead>
                                <tr>
                                    <th>Admin</th>
                                    <th>Cod.</th>
                    ...
                    <div style="color:#FFF;border-radius:5px;" id="tabela_estorno_back_historico" class="dsnone">
                        <div class="p-2" style="background-color:#123449;border-radius:5px;">
                            <table id="tabela_estorno_table_back_historico"
                                   class="table table-sm listarestornosbackhistorico w-100">
                                <thead>
                                <tr>
                                    <th>Admin</th>
                                    <th>Plano</th>
    ...
    <div class="modal fade" id="exampleModalTipoPlanosHistoricoCorretora" tabindex="-1"
         aria-labelledby="exampleModalLabelTipoPlanosHistoricoCorretora" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div>
                        <input type="checkbox" name="planos_tipo_individual_historico"
                               id="planos_tipo_individual_historico" checked> Individual
                    </div>
                    <div>
                        <input type="checkbox" name="planos_tipo_coletivo_historico" id="planos_tipo_coletivo_historico"
                               checked> Coletivo
                        <div class="w-75 ml-4">
                    ...
                    <div>
                        <input type="checkbox" name="planos_tipo_empresarial_historico"
                               id="planos_tipo_empresarial_historico" checked> Empresarial
                        <div class="w-75 ml-4">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-block btn-primary gerar_pdf_corretora_link_historico">Gerar
                        PDF
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="exampleModalTipoPlanos" tabindex="-1" aria-labelledby="exampleModalLabelTipoPlanos"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div>
                        <input type="checkbox" name="planos_tipo_individual" id="planos_tipo_individual" checked>
                        Individual
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="checkbox" name="planos_tipo_empresarial" id="planos_tipo_empresarial" checked>
                        Empresarial
    ...
    <div class="modal fade" id="exampleModalTipoPlanosCorretora" tabindex="-1"
         aria-labelledby="exampleModalLabelTipoPlanosCorretora" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div>
                        <input type="checkbox" name="planos_tipo_individual_corretora"
                               id="planos_tipo_individual_corretora" checked> Individual
                    </div>
                    <div>
                        <input type="checkbox" name="planos_tipo_coletivo_corretora" id="planos_tipo_coletivo_corretora"
                               checked> Coletivo

                    </div>
                    <div>
                        <input type="checkbox" name="planos_tipo_empresarial_corretora"
                               id="planos_tipo_empresarial_corretora" checked> Empresarial
...
@section('js')
    ...
    <script>
        ...
        $(function () {
            ...
            $("#ano_folha_historico").on('change', function () {
                $("#mes_folha_historico").removeAttr('disabled');
            ...
            var listarestornos = $(".listarestornos").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: "total_estorno",
                        width: "5%",
                        className: 'dt-center total_estorno',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ ')
                    },
                    {
            ...
            $("body").on('change', '.confirmar_estorno', function () {
                ...
                $("#valor_total_estorno_vendedor").val(calcular_estorno.toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }).replace("R$", ""));
                let total_input = $("#total_campo_vendedor").val().replace(/\./g, '').replaceAll(',', '.').trim();
                let total_calculado = total_input - parseFloat(estorno);
                $("#total_campo_vendedor").val(total_calculado.toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }).replace("R$", ""));
                $.ajax({
            ...
            var listarestornosbackhistorico = $(".listarestornosbackhistorico").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: "total_estorno",
                        width: "5%",
                        className: 'dt-center total_estorno_back',
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ ')
                    },
                    {
                        data: "id", name: "id", width: "5%",
            ...
            function totaisSalariais(user) {
                $.ajax({
                    ...
                    method: "POST",
                    success: function (res) {
                        $("#salario_historico").val(parseFloat(res.valor_salario).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                        $("#comissao_historico").val(parseFloat(res.valor_comissao).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                        $("#premiacao_historico").val(parseFloat(res.valor_premiacao).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                        $("#valor_total_estorno_historico").val(parseFloat(res.valor_estorno).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                        $("#valor_total_desconto_historico").val(parseFloat(res.valor_desconto).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                        $("#total_campo_historico").val(parseFloat(res.valor_total).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL'
                        }));
                    }
            ...
            function calcularContagemESoma() {
                ...
                $("#valor_total_individual_total_historico").text(parseFloat(totalValorIndividual).toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }));
                $("#valor_total_coletivo_total_historico").text(parseFloat(totalValorColetivo).toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }));
                $("#valor_total_empresarial_total_historico").text(parseFloat(totalValorEmpresarial).toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }));
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.data && res.data != null && res.data != "") {
                            ...
                            $("#valor_total_individual_total_historico").text(parseFloat(res.total_individual).toLocaleString('pt-BR', {
                                style: 'currency',
                                currency: 'BRL'
                            }));
                            $("#valor_total_coletivo_total_historico").text(parseFloat(res.total_coletivo).toLocaleString('pt-BR', {
                                style: 'currency',
                                currency: 'BRL'
                            }));
                            $("#valor_total_empresarial_total_historico").text(parseFloat(res.total_empresarial).toLocaleString('pt-BR', {
                                style: 'currency',
                                currency: 'BRL'
                            }));
                            $("#aba_historico_empty").html("");
                            $("#container_table_aba_historico").slideDown('slow').css({
                                "display": "flex",
            ...
            function total_mes_atual() {
                let mes_atual = $("#mes_folha").val();
                let ano_atual = $("#ano_folha option:selected").val();
                $.ajax({
                    url: "{{route('totalizar.mes.gerente')}}",
                    method: "POST",
                    data: "mes=" + mes_atual + "&ano=" + ano_atual,
                    success: function (res) {
                        console.log(res);
            ...
            $("body").on('click', '.user_destaque_historico', function () {
                ...
                let mes_historico = $("#mes_folha_historico option:selected").val();
                let ano_historico = $("#ano_folha_historico option:selected").val();
            ...
            $("body").on('click', '.user_destaque', function () {
                ...
                $("#container_btns").html(`
                    ...
                    <button class="btn btn-info btn-sm btn-block mt-1 gerar_pdf_corretora_link" data-id="${id}" style="font-size:0.8em;"  target="_blank">PDF Corretora</button>
                    <button class="btn btn-info btn-sm btn-block mt-1 gerar_pdf_corretor_link" data-id="${id}" style="font-size:0.8em;"  target="_blank">PDF Corretor</button>
                `).addClass('d-flex')
                $(".listar_estorno_ul li").removeClass("ativo");
                $(".listar li").removeClass("ativo");
                if ($("#tabela_estorno_table").is(':visible')) {
                ...
                let ano = $("#ano_folha option:selected").val();
                $.ajax({
                    url: "{{route('gerente.listagem.confirmadas.especifica')}}",
                    data: "mes=" + mes + "&id=" + id + "&ano=" + ano,
                    method: "POST",
                    success: function (res) {
                        ...
                        $("#adiantamento_vendedor").val(res.adiantamento);
            ...
            $('#confirmBtn').click(function () {
                ...
                let ano = $("#ano_folha").find('option:selected').val();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res == "sem_mes") {
                            ...
                            $('#ano_folha').removeAttr('disabled');
                            $('#ano_folha option').removeAttr('selected');
                        }
                    }
                });
            ...
            $("#mes_folha_historico").on('change', function () {
                listaraptosapagarhistorico.clear().draw();
                $("#listar_individual_apto_historico").removeClass('ativo');
                $("#total_quantidade_individual_historico").text(0);
                $("#valor_total_individual_historico").text(0);
                $("#salario_vendedor_historico").val(0);
                $("#comissao_vendedor_historico").val(0);
                $("#premiacao_vendedor_historico").val(0);
                $("#valor_total_estorno_vendedor_historico").val(0);
                $("#total_campo_vendedor_historico").val(0);
                ...
                let selectedText = $("#mes_folha_historico option:selected").text();
                let ano = $("#ano_folha_historico option:selected").val();
            ...
            function changeCorretor(id_user_select) {
            ...
            var listaraptosapagarhistorico = $(".listaraptosapagarhistorico").DataTable({
                ...
                columns: [
...

                    {
                        ...
                        width: "3%",
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ '),
                        className: 'comissao_receber'
                    },
                    {
                        data: "desconto",
                        name: "desconto",
                        className: "desconto_atual",
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ '),
                        width: "3%"
                    },
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $("#previsao_de_comissao").html("Previsão da Comissão: " + conditionalTotal.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }));
                }
            ...
            $('body').on('click', '.removeButton', function () {
                ...
                if (desconto != 0) {
                    ...
                    let total = parseFloat(desconto_refatorado).toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }).replace("R$", "");
            ...
            function calcularValorTotal(id) {
                ...
                let valorColetivo = 0;
                let valorEmpresarial = 0;
                let total = valorIndividual + valorColetivo + valorEmpresarial;


                $("#comissao_vendedor").val(parseFloat(total).toLocaleString('pt-br', {
                    style: 'currency',
                    currency: 'BRL'
                }).replace("R$", ""));
                ...
                let adiantamento = $("#adiantamento_vendedor").val().replace(/\./g, '').replace(',', '.');
                let total_valor = (parseFloat(comissao)) - adiantamento - desconto;

                total_valor = total_valor - estorno;
                $("#total_campo_vendedor").val(parseFloat(total_valor).toLocaleString('pt-br', {
                    style: 'currency',
                    currency: 'BRL'
                }).replace("R$", ""));
                let mes = $("#mes_folha option:selected").val();
            ...
            var listarcomissaomesrecebidashistorico = $(".listarcomissaomesrecebidashistorico").DataTable({
                ...
                columns: [
                    ...
                    {
                        data: "comissao_esperada",
                        name: "comissao_esperada",
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ '),
                        className: 'dt-center comissao_recebida',
                        "createdCell": function (td, cellData, rowData, row, col) {

                            if (rowData.valor_pago != null) {
                                let valor = parseFloat(rowData.valor_pago).toLocaleString('pt-BR', {
                                    style: 'currency',
                                    currency: 'BRL'
                                })
                                $(td).html(valor);
                            } else {
                                let valor = parseFloat(cellData).toLocaleString('pt-BR', {
                                    style: 'currency',
                                    currency: 'BRL'
                                })
                                $(td).html(valor);
            ...
            $("#listar_coletivo_apto_historico").on('click', function () {
                ...
                if (id) {
                    ...
                    if ($("#tabela_principal_historico").is(':visible')) {
                        $("#tabela_principal_historico").slideUp('fast', function () {
                            $("#title_individual_confirmados_historico").html("<h4>Coletivo</h4>");
                            listaraptosapagarhistorico.ajax.url(`{{ url('/admin/gerente/comissao/coletivo/confirmadas/${id}/${mes}') }}`).load();
                            $("#tabela_aptos_a_pagar_historico").slideDown('slow');
                        });
                    }
            ...
            $("#listar_empresarial_apto_historico").on('click', function () {
                ...
                if (id) {
                    ...
                    if ($("#tabela_principal_historico").is(':visible')) {
                        $("#tabela_principal_historico").slideUp('fast', function () {
                            $("#title_individual_confirmados_historico").html("<h4>Empresarial</h4>");
                            listaraptosapagarhistorico.ajax.url(`{{ url('/admin/gerente/comissao/empresarial/confirmadas/${id}/${mes}') }}`).load();
                            $("#tabela_aptos_a_pagar_historico").slideDown('slow');
                        });
                    }
            ...
            $("body").on('click', '.pagar_comissao_up', function () {
                ...
                if (plano == 1) {
                    ...
                    $("#valor_total_individual").text(total_individual.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }).replace("R$", ""));
                    desconto = 0;
                    ...
                    $("#valor_total_coletivo").text(total_coletivo.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }).replace("R$", ""));
                    desconto = 0
                    ...
                    $("#valor_total_empresarial").text(total_empresarial.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }).replace("R$", ""));
                    desconto = 0;
                ...
                let premiacao_vendedor_campo = 0;
                ...
                let adiantamento_total = $("#adiantamento_vendedor").val().trim() != "" || $("#adiantamento_vendedor").val().trim() != 0 ? $("#adiantamento_vendedor").val().trim().replace(/\./g, "") : parseFloat(0);
                let adiantamento_total_convertido = adiantamento_total != 0 ? parseFloat(adiantamento_total.replace(",", ".")) : 0;

                let user_id = $("#corretor_escolhido").val();

                let somar_ganhos = 0 + comissao_vendedor_campo_convertido + 0;
                ...
                let subtrair_adiantamento = subtrair_estorno - adiantamento_total_convertido;
                let subtratir_adiantamento_formatado = subtrair_adiantamento.toLocaleString('pt-BR', {minimumFractionDigits: 2});

                $("#total_campo_vendedor").val(subtratir_adiantamento_formatado);
                $(".estilizar_search input[type='search']").val('');
                listarcomissaomesdfirente.search('').draw();
                listarcomissaomesrecebidas.search('').draw();
                listaraptosapagar.search('').draw();
                ...
                $.ajax({
                    ...
                    data:
                        ...
                        "&user_id=" + user_id +
                        "&adiantamento="+adiantamento_total+
            ...
            var listarcomissaomesdfirente = $(".listarcomissaomesdiferente").DataTable({
                ...
                columns: [
                    ...
                    {
                        data: "id",
                        name: "comissao_pagando",
                        render: $.fn.dataTable.render.number('.', ',', 2, 'R$ '),
                        width: "7%",
                        "createdCell": function (td, cellData, rowData, row, col) {
                            let valor_comisao = parseFloat(rowData.valor).toLocaleString('pt-BR', {
            ...
            $('#adiantamento_vendedor').mask("#.##0,00", {reverse: true});
            ...
            $("#valor_total_estorno_vendedor").on('change', function () {
                ...
                f = valor_com_estorno.toLocaleString('pt-br', {
                    style: 'currency',
                    currency: 'BRL'
                }).replace("R$", "").trim();
            ...
            $(".adiantamento_usuario_vendedor").on('change', function () {
                ...
                let valor_input = comissao_numerica - desconto - estorno - valor_numerico;
            ...
            $("body").on('click', '.gerar_pdf_corretora_link', function () {
                let dados = {
                    ...
                    "ano": $("#ano_folha option:selected").val(),
                    "tipo": "corretora"
                };
            ...
            var tableareceber = $(".listardados").DataTable({
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $(".valor_quat_comissao_a_receber").html(conditionalTotal.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    }));
...
@section('css')
    <style>
        ...
        #listar_individual_apto, #listar_coletivo_apto, #listar_empresarial_apto, #listar_individual_apto_total, #listar_coletivo_apto_total, #listar_empresarial_apto_total span {
            color: #FFF;
        }
        ...
        .aba_comissao_container, .aba_historico_container {
            display: flex;
        ...
        #list_user::-webkit-scrollbar, #list_user_historico::-webkit-scrollbar {
            width: 2px;
            height: 2px !important;
            background-color: white;
        }

        #list_user::-webkit-scrollbar-thumb, #list_user_historico::-webkit-scrollbar-thumb {
        ...
        .dataTables_wrapper .dataTables_wrapper .dataTables_scrollBody td, .dataTables_wrapper .dataTables_wrapper .dataTables_scrollBody th {
            padding: 0;
        }
        ...
        .estilizar_pagination .pagination {
            font-size: 0.8em !important;
            color: #FFF;
        }

        .estilizar_pagination .pagination li {
            height: 10px;
            color: #FFF;
        }
        ...
        .por_pagina #tabela_mes_atual_length {
            display: flex;
            align-items: center;
            align-self: center;
            margin-top: 8px;
        ...
        .por_pagina #tabela_mes_diferente_length {
            display: flex;
            align-items: center;
            align-self: center;
            margin-top: 8px;
        ...
        #tabela_individual_previous {
            color: #FFF !important;
            background-color: red !important;
        }

        #tabela_individual_next {
            color: #FFF !important;
        }

        #tabela_coletivo_previous {
            color: #FFF !important;
        }

        #tabela_coletivo_next {
            color: #FFF !important;
        }
        ...
        .tabela_individual_paginate {
            color: #FFF !important;
        }

        .link_coletivo_um:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_coletivo_dois:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_coletivo_tres:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_coletivo_quatro:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_coletivo_cinco:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_coletivo_seis:hover {
            background-color: rgb(245, 50, 16) !important;
        }

        .link_empresarial_um:hover {
            background-color: rgb(254, 200, 109) !important;
        }

        .link_empresarial_dois:hover {
            background-color: rgb(254, 200, 109) !important;
        }

        .link_empresarial_tres:hover {
            background-color: rgb(254, 200, 109) !important;
        }

        .link_empresarial_quatro:hover {
            background-color: rgb(254, 200, 109) !important;
        }

        .link_empresarial_cinco:hover {
            background-color: rgb(254, 200, 109) !important;
        }

        .link_empresarial_seis:hover {
            background-color: rgb(254, 200, 109) !important;
        }

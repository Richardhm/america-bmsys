...
@section('content_top_nav_right')
    ...
    <li class="nav-item"><a class="nav-link te'xt-white" href="{{route('home.administrador.consultar')}}">Consultar</a></li>
...
@section('content')
    ...
    <section class="conteudo_abas">
        ...
        <section class="d-flex justify-content-between" style="flex-wrap: wrap;align-content: flex-start;">
            ...
            <div class="d-flex flex-column text-white ml-1" style="flex-basis:16%;border-radius:5px;">                    
                ...
                <div class="d-flex justify-content-between mb-1">
                    <span class="btn" style="background-color:#123449;color:#FFF;font-size:1.2em;flex-basis:99%;">Contratos</span>
                </div>
            ...
            <div style="flex-basis:83%;">
                <div class="p-2" style="background-color:#123449;color:#FFF;border-radius:5px;">
                    <table id="tabela_contratos" class="table table-sm listartodos">
                        <thead>
                            <tr>
                                <th>Data</th>
                                <th>Orçamento</th>
        ...
        <!--------------------------------------INDIVIDUAL------------------------------------------>
        <main id="aba_individual" class="ocultar">
            ...
            $(".listardados").DataTable({
                ...
                "drawCallback":function(settings) {
                    ...
                    if(settings.iDraw >= 3 && settings.sTableId == "tabela_coletivo") {
                        ...
                        var api = this.api();
                        total_vidas = api.column(6).data().reduce(function (a, b) {
	                        return intVal(a) + intVal(b);
                        }, 0);
